...
void SerializationSample::OnInit(){
    {
    ...
    {
        std::stringstream os("out.cereal");
        cereal::JSONOutputArchive archive(os);
        ...
        LogWarning("%s", os.str().c_str());
    }

    {
        std::ifstream is("out.cereal");
        //std::stringstream is("out.cereal");
    ...
    {   
        ...
        int someInt = 996;
        double d = 3.13546546;
        archiveOut(myData, someInt, d);
        //LogWarning("%s", ss.str().c_str());
        ...
        int inSomeInt;
        double inD;
        archiveIn(inMyData, inSomeInt, inD);
        LogWarning("%s %d, %d %d", inHeader, inMyData.x, inMyData.y, inMyData.z);
        Assert(inMyData.type == MyClass::Type::B);
    }
...
void SerializationSample::OnUpdate(float deltaTime){}
void SerializationSample::OnRender(float deltaTime){}
void SerializationSample::OnGUI(){}
void SerializationSample::OnResize(int width, int height){}
void SerializationSample::OnExit(){}
