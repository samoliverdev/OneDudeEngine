...
void UniformBufferSample::OnInit(){
    LogInfo("Game Init");
...
void UniformBufferSample::OnUpdate(float deltaTime){
    camMove.OnUpdate();
    //modelTransform.localEulerAngles(Vector3(0, Platform::GetTime() * 20, 0));
}   

void UniformBufferSample::OnRender(float deltaTime){
...
void UniformBufferSample::OnGUI(){
...
void UniformBufferSample::OnResize(int width, int height){}
void UniformBufferSample::OnExit(){}