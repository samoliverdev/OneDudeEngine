...
void CharacterControllerSample::OnInit(){
...
void CharacterControllerSample::OnUpdate(float deltaTime){}   
void CharacterControllerSample::OnRender(float deltaTime){}
void CharacterControllerSample::OnGUI(){}
void CharacterControllerSample::OnResize(int width, int height){}
void CharacterControllerSample::OnExit(){}