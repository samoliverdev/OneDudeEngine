...
void BaseMeshSample::OnInit(){
    ...
    auto f = tarPackage.find_header("DefaultAssets/Textures/White.jpg");
    Assert(f != nullptr);
    LogWarning("Size: %zd", f->GetSize());

    //auto tex2 = Texture2D::CreateFromMemory((void*)f->GetData(), f->GetSize(), Texture2DSetting());
    auto tex2 = Texture2D::CreateFromPackage("DefaultAssets/Textures/White.jpg", tarPackage, Texture2DSetting());

    LogWarning("Tex2 Width: %d", tex2->Width());
    Assert(tex2 != nullptr);

    /*auto tex = Texture2D::CreateFromFile("C:/Users/sam/Desktop/cpp/OneDudeEngine/Engine/data/Engine/Textures/White.jpg", Texture2DSetting());
    LogWarning("Tex Width: %d", tex->Width());
    Assert(tex != nullptr);*/
