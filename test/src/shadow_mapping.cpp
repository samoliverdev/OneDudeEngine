...
int main()
{
    ...
    // -------------------------
    Shader shader("res/test/10.shadow_mapping.vs", "res/test/10.shadow_mapping.fs");
    Shader simpleDepthShader("res/test/10.shadow_mapping_depth.vs", "res/test/10.shadow_mapping_depth.fs", "res/test/10.shadow_mapping_depth.gs");
    Shader debugDepthQuad("res/test/10.debug_quad.vs", "res/test/10.debug_quad_depth.fs");
    Shader debugCascadeShader("res/test/10.debug_cascade.vs", "res/test/10.debug_cascade.fs");
    ...
    // load textures
    // -------------
    unsigned int woodTexture = loadTexture("res/textures/block.png");
