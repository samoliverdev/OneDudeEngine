...
void HeadlessGraphicsDevice::DrawMesh(Mesh& mesh, Matrix4 modelMatrix){}
void HeadlessGraphicsDevice::DrawMeshSkinned(Mesh& mesh, Matrix4 model, Matrix4* animMatrix, int count){}
void HeadlessGraphicsDevice::DrawMeshInstancing(Mesh& mesh, Matrix4* modelMatrixs, int count){}

void HeadlessGraphicsDevice::DrawMesh(Mesh& mesh, Material& shader, Matrix4 modelMatrix){}
void HeadlessGraphicsDevice::DrawMeshSkinned(Mesh& mesh, Material& shader, Matrix4 model, Matrix4* animMatrix, int count){}
