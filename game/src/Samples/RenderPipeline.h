...
struct RenderPipelineSample: public OD::Module {
    ...
    void OnInit() override {
        ...
        scene->AddEntityWith<TransformComponent, ModelRendererComponent>("Plane", [&](auto& transform, auto& meshRenderer){
            ...
            m->SetTexture("mainTex", AssetManager::Get().LoadAsset<Texture2D>("res/Game/Textures/brickwall.jpg"));
            m->SetTexture("normal", AssetManager::Get().LoadAsset<Texture2D>("res/Game/Textures/brickwall_normal.jpg"));
