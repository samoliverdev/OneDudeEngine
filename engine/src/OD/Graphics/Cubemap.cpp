...
Ref<Cubemap> Cubemap::CreateFromFileHDR(const char* hdri){
    ...
    // ----------------------------------------------------------------------
    Ref<Shader> equirectangularToCubemapShader = Shader::CreateFromFile("res/Engine/Shaders/EquirectangularToCubemap.glsl");
    ...
    // -----------------------------------------------------------------------------
    Ref<Shader> irradianceShader = Shader::CreateFromFile("res/Engine/Shaders/IrradianceConvolution.glsl");
...
Ref<Cubemap> Cubemap::CreatePrefilterMapFromCubeMap(const Ref<Cubemap>& cubemap){
    ...
    // ----------------------------------------------------------------------------------------------------
    Ref<Shader> prefilterShader = Shader::CreateFromFile("res/Engine/Shaders/Prefilter.glsl");
