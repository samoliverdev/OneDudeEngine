...
void MultiCompileShader::DisableKeyword(std::string keyword){
...
void MultiCompileShader::EnableKeyword(std::string keyword){
...
std::set<std::string> MultiCompileShader::GetEnabledKeywords(){
...
void MultiCompileShader::SetCurrentShader(){
    UpdateCurrentShader();
}
...
void MultiCompileShader::UpdateCurrentShader(){
